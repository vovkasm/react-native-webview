...
import { UIManager, View, requireNativeComponent, NativeModules, Image, findNodeHandle, } from 'react-native';
...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.goForward = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().goForward);
        };
        /**
         * Go back one page in the web view's history.
         */
        _this.goBack = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().goBack);
        };
        /**
        ...
        _this.reload = function () {
            ...
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().reload);
        };
        /**
         * Stop loading the current page.
         */
        _this.stopLoading = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().stopLoading);
        };
        /**
         * Request focus on WebView rendered page.
         */
        _this.requestFocus = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().requestFocus);
        };
        /**
    ...
    WebView.prototype.getCommands = function () {
